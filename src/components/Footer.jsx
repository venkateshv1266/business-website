    ...
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
        ...
        <div className='flex-1 flex flex-col justify-start'>
          ...
          <input className='mt-4 rounded-lg p-4' type='text' placeholder='Enter Name'></input>
          <textarea className='mt-4 rounded-lg p-4' type='text' placeholder='Enter Query' />
          <Button title="Submit Query" styles='mt-10' />
